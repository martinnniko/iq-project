document.addEventListener("DOMContentLoaded", () => {
  ...
  const closeProgramBtn = programModal
    ? programModal.querySelector(".modal-close")
    : null;
  ...
  const programsData = {
    marketing: {
      ...
      overview:
        "The program introduces you to the core areas of modern marketing, including SEO, social media, content, and analytics. Through guided lessons and practical exercises, you’ll gain the skills to design and manage campaigns that deliver measurable results.",
      price: "1,599€ + VAT",
    ...
    "graphic-design": {
      ...
      overview:
        "The program covers key areas of modern design—from concept and layout to typography and digital media—preparing you to create professional, market-ready visuals.",
      price: "1,699€ + VAT",
      spots: "Only 2 spots left",
    },
    "ui-ux": {
      ...
      overview:
        "Learn the complete design process from research and wireframing to prototyping and testing. This program helps you build a strong foundation in design thinking, usability, and visual design to create seamless digital experiences.",
      price: "1,699€ + VAT",
    ...
    motion: {
      ...
      overview:
        "Develop your creative and technical skills in animation, compositing, and visual storytelling. You’ll explore industry tools like After Effects and Premiere Pro while producing dynamic motion projects that showcase your style and creativity.",
      price: "2,099€ + VAT",
      spots: "Only 5 spots left",
    },
    interior: {
      ...
      overview:
        "Explore the full interior design process — from concept and color theory to space planning and materials. Through practical projects, you’ll learn to design functional and visually captivating spaces for modern living.",
      price: "2,099€ + VAT",
      spots: "Only 2 spots left",
    },
    frontend: {
      ...
      overview:
        "Master web design, coding, and interactivity through practical training and real-world projects designed to equip you with the skills to build responsive, user-focused, and visually dynamic websites.",
      price: "2,099€ + VAT",
    ...
    openButtons.forEach((btn) => {
      btn.addEventListener("click", (e) => {
        ...
        if (data) {
          ...
          programModal.querySelector(".section-text-max").textContent =
            data.overview;
          ...
          if (spotsElement) {
            ...
            spotsElement.style.color =
              data.spots === "Enrollment Closed" ? "red" : "";
          }
  ...
  document.addEventListener("keydown", (e) => {
    if (
      e.key === "Escape" &&
      programModal &&
      programModal.classList.contains("is-visible")
    ) {
      programModal.classList.remove("is-visible");
      document.body.style.overflow = "auto";
    }
